        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              ...
              <!-- / quick view modal -->   
            <div class="col-md-12 col-sm-12 product-paging">
					<ul class="pagination pull-right">
						<c:if test="${tag>=1}">
						<li><a href="${pageContext.request.contextPath }/view/client/product?index=${tag-1}">&laquo;</a></li>
						</c:if>
						<c:forEach begin="1" end="${endP}" var="i">
							<li class='${tag==i?"active":"" }'>
							<a class="mx-3 p-3" href="${pageContext.request.contextPath}/view/client/product?index=${i}">${i}</a>
							</li>
						</c:forEach>
						<c:if test="${tag<endP}">
						<li><a href="${pageContext.request.contextPath}/view/client/product?index=${tag+1}">&raquo;</a></li>
						</c:if>
					</ul>
			</div>
            </div>
