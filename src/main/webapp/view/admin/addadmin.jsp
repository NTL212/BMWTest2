              ...
              <div class="card-body"> 
                ...
                <form action="${pageContext.request.contextPath}/admin/admin/add" method="post"> 
                  ...
                  <div class="form-group"> 
                    ...
                    <input type="text" value="NULL" class="form-control" id="input-1" placeholder="Username"  name="admin-username"> 
                  </div> 
                  <div class="form-group"> 
                 ...
                 <div class="form-group"> 
                    ...
                    <input type="text" class="form-control"  placeholder="Tên Admin" name="admin-name" value = ""> 
                  </div>	
